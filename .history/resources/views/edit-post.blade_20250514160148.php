...
<head>
    ...
    <title>Edit Post | CRUD System</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark">
        <div class="container">
            <a class="navbar-brand" href="{{ route('home') }}"><i class="fas fa-cube me-2"></i>CRUD System</a>
                        ...
                        <form action="{{ route('posts.update', $post->id) }}" method="POST">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="form-control @error('body') is-invalid @enderror" id="body" name="body" 
                                    rows="6" placeholder="Enter post content" required>{{ old('body', $post->body) }}</textarea>
                                @error('body')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
